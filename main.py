...
def start(client, message):
    kb = [[InlineKeyboardButton('Channel 🛡', url=chnnl),InlineKeyboardButton('Support 🔰', url="https://t.me/FZBOTS")]]
...
def tiktok_dl(client, message):
    ...
    headers = {
      ...
      'x-rapidapi-key': "ffb3e98f33msh483d63655d8041ap10df3ejsnad2c85dedeb2"
    }
